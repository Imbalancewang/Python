...
def writeToJson(res=[]):
    fp=open('/Users/rd/Desktop/Python/crawling/museumInformation.json','w+')
    for i in res:
...
if __name__=='__main__':
    ...
    #url='https://baike.baidu.com/item/%E5%8C%97%E4%BA%AC%E6%95%85%E5%AE%AB%E5%8D%9A%E7%89%A9%E9%99%A2#3'
    result=[]
    for each_url in url:
        html=download(each_url)
        temp=[]
        temp=getBasicInformation(html)
        result.append(temp)
    #print res[0]
    writeToJson(result)